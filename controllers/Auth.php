...
class Auth extends CI_Controller {
	...
	public function register()
	{
		...
		if ($this->form_validation->run() == true)
		{
			...
			<div class="col-lg-12">
				<div class="alert alert-success alert">Registrasi Berhasil, silahkan login untuk mulai berbelanja.</div>
			</div>');
			redirect(base_url());
		}
			else
	...
	public function edit_profil($id)
	{
		...
		// mengambil data group atau usertype dan ditampilkan pada halaman edit/ update
